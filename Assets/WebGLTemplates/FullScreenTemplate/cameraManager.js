...
*/
    ...
    p.prototype.start = function() {
        ...
        var b = this.g;
        let options = {facingMode: b.facingMode};
        if(!b.aspectRatio) options["width"] = b.width;
        if(!b.aspectRatio) options["height"] = b.height;
        if(b.aspectRatio) options["aspectRatio"] = b.aspectRatio;
